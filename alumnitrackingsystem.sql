...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2022 at 09:56 PM
...
(6, '20210003', '12563781982', '09/21/2021', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(7, '20210004', '', '', '1234342', '11/2/2021', '', '', '', '', '', '', '', '', '', '', '', ''),
(8, '20210005', '32542332', '12-25-2021', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
...
INSERT INTO `post_tbl` (`id`, `post_no`, `post`, `date`, `time`) VALUES
...
(1, '20210000', 'Doe', 'John', 'Doe', 'Kalibo Aklan', 'Male', 'single', '', '', '', '', '', '', '', '', '', '', '', 'doejohn@d.com', 'admin', 'admin', '', '1', ''),
...
--
ALTER TABLE `users_tbl`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20210020;
COMMIT;
